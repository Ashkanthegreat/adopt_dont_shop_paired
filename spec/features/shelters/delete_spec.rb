...
describe "deleting a shelter" do
  before :each do
    ...
    @pet4 = Pet.create(image: "https://pixabay.com/get/5ee0d44b4854b10ff3d89960c62d3f761d37dae25757_640.jpg", name: "Arrow", approximate_age: "12", sex: "Male", shelter_id: @shelter2.id, adoption_status: "Pending")
    @pet5 = Pet.create(image: "https://pixabay.com/get/5ee0d44b4854b10ff3d89960c62d3f761d37dae25757_640.jpg", name: "Spike", approximate_age: "14", sex: "Male", shelter_id: @shelter3.id, adoption_status: "adoptable")
    @pet6 = Pet.create(image: "https://pixabay.com/get/5ee0d44b4854b10ff3d89960c62d3f761d37dae25757_640.jpg", name: "Ace", approximate_age: "12", sex: "Male", shelter_id: @shelter3.id, adoption_status: "adoptable")
